...
function rutas(app,passport){
         ...
         if(resultado[0] == null){
            ...
            connection.query(linea0,(err,resultado_salon)=>{
               if(err) throw err;
                  ...
                  var linea1='insert into turno(id_salon,turno,resta,dia) SELECT '+id+',\''+req.body.turno+'\','+resultado_salon[0].capacidad+',\''+req.body.fecha+'\''+
                                    'WHERE NOT EXISTs(SELECT '+id+',\''+req.body.turno+'\','+resultado_salon[0].capacidad+',\''+req.body.fecha+'\''+
                                    ' FROM turno t WHERE t.id_salon='+id+' AND t.turno=\''+req.body.turno+'\' AND t.dia=\''+req.body.fecha+'\')';
    ...
    */
    ...
    app.get('/horariosTotal',(req,res,next)=>{
    ...
    app.get('/comprobar_comensales',(req,res,next)=>{
  ...
  var weekday = new Array(7);
   ...
   /////////// Rutas para mis_reservas  ///////////////////
   app.post('/consultar_reserva',(req,res,next)=>{

      var linea12 = 'SELECT * FROM reserva WHERE email=\''+req.body.email+'\' AND id_reserva='+req.body.codigo;
      console.log(linea12);
      connection.query(linea12,(err12,res12)=>{
         if(err12) throw err12;

         res.send(JSON.stringify(res12));
      });
   });
   app.post('/enviar_codigo',(req,res,next)=>{

      var linea12 = 'SELECT * FROM reserva WHERE email=\''+req.body.email+'\'';
      console.log(linea12);
      connection.query(linea12,(err12,res12)=>{
         if(err12) throw err12;
